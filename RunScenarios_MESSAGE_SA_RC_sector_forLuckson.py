...
def addMissingVariables(model,scen_out,ssp):
    ...
    reporting_in.to_csv('C:\\Users\\dwabel\\Documents\\Message_Oliver\\message_data\\post-processing\\output\\'+model+'_'+scen_out+'_appended.csv', index=False)
...
for ssp in ssp:
    ...
    for tec in tec_list:
        scen_out = [(tec+'_+200_ic'),(tec+'_+100_ic'),(tec+'_+50_ic'),(tec+'_+10_ic'),
                    (tec+'_-10_ic'),(tec+'_-50_ic'),(tec+'_-100_ic'),(tec+'_-200_ic')]
        scale = [200,100,50,10,-10,-50,-100,-200]
